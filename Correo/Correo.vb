...
Public Class Correo
    Public Shared Function enviarEmail(ByVal toEmail As String, ByVal mensaje As String, ByVal asunto As String) As Boolean
        Try
            'Direccion de origen
            Dim from_address As New MailAddress("...@gmail.com", "Asunto")
            'Direccion de destino
            Dim to_address As New MailAddress(toEmail)
            'Password de la cuenta
            Dim from_pass As String = "password"
