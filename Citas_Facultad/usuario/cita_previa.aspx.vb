...
Public Class cita_previa
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            Dim n = Citas_Facultad.DataWriter.insertar_cita(cita.dia, cita.hora, Request.QueryString("tramite"), cita.idSecretario, Session("usuario"), cita.duracion)
            Try
                Dim id = CInt(n)
                ...
                Correo.Correo.enviarEmail(Session("Usuario"), mensaje, "Cita previa")
                Response.Redirect("confirmacion.aspx?cita=" & id)
