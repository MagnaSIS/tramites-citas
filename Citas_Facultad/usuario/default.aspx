<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MaestraUsuario.Master" CodeBehind="default.aspx.vb" Inherits="Citas_Facultad.pedir_cita" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="jumbotron" runat="server">
    <div style="text-align: initial;">
        ...
        <p>
            <asp:Label ID="Label3" runat="server" Text="Seleccione el Grado y el trámite que desea realizar." meta:resourcekey="Label3Resource1"></asp:Label>
        </p>
        <p>
            <asp:Label ID="Label4" runat="server" Text="Si necesita realizar más de un trámite, deberá solicitar otra cita previa de nuevo para ese segundo trámite." meta:resourcekey="Label4Resource1"></asp:Label>
        </p>
    </div>
