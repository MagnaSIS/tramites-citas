<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MaestraSecretario.Master" CodeBehind="cita_previa.aspx.vb" Inherits="Citas_Facultad.cita_previa1" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="jumbotron" runat="server">
    <div style="text-align: initial;">
        ...
        <asp:SqlDataSource ID="alumnos" runat="server" ConnectionString="<%$ ConnectionStrings:DatabaseConnectionString %>" ProviderName="<%$ ConnectionStrings:DatabaseConnectionString.ProviderName %>" SelectCommand="SELECT email FROM usuarios WHERE (tipo = 'Alumno')">
        </asp:SqlDataSource>
        <h3>
            <asp:Label ID="Label6" runat="server" Text="Trámites" meta:resourcekey="Label6Resource1"></asp:Label>
        </h3>
        ...
        <ContentTemplate>
            <div class="row" style="padding-top: 10px;">
                ...
                <div class="col-sm-6" style="text-align: initial;">
                    ...
                    <br />
                    <asp:Label ID="Label7" runat="server" Text="Alumno" meta:resourcekey="Label7Resource1"></asp:Label>
                    <br />
                    <asp:DropDownList ID="alumnoDDL" runat="server" DataSourceID="alumnos" CssClass="form-control" AutoPostBack="True" DataTextField="email" DataValueField="email" meta:resourcekey="alumnoDDLResource1"></asp:DropDownList>
                    <br />
